...
public class SwordSwitch : MonoBehaviour
{
    ...
    private IEnumerator ChangeColor()
    {
        ...
        _randomColor = new Color(Random.Range(0.5f, 1.25f), Random.Range(0.5f, 1.25f), Random.Range(0.5f, 1.25f), 1.0f);
        ...
        while (t < 1)
        {
            ...
            _swordVfx.SetVector4("GeneralColor", Vector4.Lerp(_actualColor, _randomColor, t));
